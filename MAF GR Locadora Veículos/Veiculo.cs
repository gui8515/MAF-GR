...
namespace MAF_GR_Locadora_Veículos
{
    class Veiculo
    {
        ...
        //Metodo construtor
        public Veiculo(string pplaca, string puf, int prenavam, string pcor, string pfabricante, string pmodelo, string pano, string pcategoria, double pkm, string pst_veiculo)
        {
            this.placa = pplaca;
            this.uf = puf;
        ...
        public bool setVeiculo()
        {
            try
            {
                ...
                string sql = "INSERT INTO tb_veiculo (ID_veiculo, Placa, UF, Renavam, Cor, Fabricante, Modelo, Ano, Categoria, Kilometragem, Status, Cam_imagem) VALUES (NULL, @Placa, @UF, @Renavam, @cor, @Fabricante, @Modelo, @Ano, @Categoria, @Kilometragem, @Status, NULL)";
